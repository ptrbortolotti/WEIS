...
class InputWriter_OpenFAST(object):
    ...
    def write_MainInput(self):
        ...
        f.write('{:<22} {:<11} {:}'.format(0, 'CompSeaSt', '- Compute sea state information (switch) {0=None; 1=SeaState}\n'))
        ...
        f.write('{:<22} {:<11} {:}'.format('"'+self.fst_vt['Fst']['HydroFile']+'"', 'SeaStFile', '- Name of file containing sea state input parameters (quoted string)\n'))
